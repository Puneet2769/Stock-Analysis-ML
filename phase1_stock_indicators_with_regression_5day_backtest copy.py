# region STEP 1: IMPORT LIBRARIES
...
# region STEP 2: DOWNLOAD STOCK DATA
...
# region STEP 3–15: BASIC CLEAN + INDICATORS + FEATURES
...
# region STEP 7 + PHASE A/B: TARGETS & DATASETS
...
# region FEATURE COLUMNS & REGRESSION TARGET
...
# region TRAIN/TEST SPLITS (CLASSIFICATION + REGRESSION)
...
# region PHASE B: 5-DAY CLASSIFIER
...
# region PHASE A: REGRESSION MODEL
...
# region STEP 10: FEATURE IMPORTANCE
...
# region PHASE C: BACKTEST EQUITY + STATS
